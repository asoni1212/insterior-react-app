...
const mapStateToProps = state => {
    const {isLoading, userData} = state.userProfileModuleReducer.GetUserDataReducer;
            ...
            <div class="container">
                <div class="main-body">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            {isEdit ? <EditProfile handleEditSave={this.handleEditSave}/> : <DisplayUserDetails handleSubmit= {this.handleEditSave} testvalue={"myvalue"}/>}
